...
import MineBreadcrumb from './components/bars/breadcrumb'
  ...
  setup() {
    ...
    onMounted(() => {
      if (menuStore.subMenu.length > 0 && appSetting?.layout === "columns") {
        ...
        menuStore.subMenu.length === 0 &&
        appSetting?.layout === "mixed"
      ) {
      ...
      <div class="app-container">
        ...
        >
          <Transition name="mine-aside-animate">
            <div
              class={{ "group mine-aside": true, "w-0": getMobileState() }}
        ...
        <div
          class="mine-max-size-exit"
          onClick={() => useTabStore().exitMaxSizeTab()}
        >
